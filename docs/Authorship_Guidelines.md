...
The Reservoir Group is a multi-PI collaboration that is grounded in the ethos of cross-disciplinary, cross-lab training. Thus, all faculty (including research scientists) will assist and support all products emanating from our research group, regardless of whether or not they are a co-author. When an authorship memo (see below) is emailed to the group, faculty will respond whether they think their contributions (past and present) merit coauthorship. We note that for many Reservoir Group products, the faculty/research scientists serve in roles that are inherently associated with coauthorship (e.g., mentoring students as they write dissertation chapters, developing project ideas/infrastructure, receiving funding that enables projects to occur, etc.). In cases when they are not co-authors on a Reservoir Group product, we want to emphasize that the faculty member/research scientist will continue to serve in a supporting role for the project (e.g., by providing feedback on work at Reservoir Group meetings, etc.).
